import { ICalculator, IResultCalculator, Taxes } from "../../helpers";
...
export default class Calculator {
   ...
   static calculateProfit(args: ICalculator): IResultCalculator {
      ...
      const percentCategoryComission = args.subCategory.wb_commission / 100;
   ...
   static createObject(): ICalculator {
      return {
         category: "",
         subCategory: "",
         priceOnWB: null,
